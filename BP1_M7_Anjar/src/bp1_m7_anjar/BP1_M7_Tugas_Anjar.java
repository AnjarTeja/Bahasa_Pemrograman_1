...
public class BP1_M7_Tugas_Anjar extends javax.swing.JFrame {
    Statement st;
    ResultSet rs;
    koneksi koneksi;

    public BP1_M7_Tugas_Anjar() {
        koneksi = new koneksi();
        initComponents();
        load_data();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BP1_M7_Tugas_Anjar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BP1_M7_Tugas_Anjar().setVisible(true);
            }
        });
    }
