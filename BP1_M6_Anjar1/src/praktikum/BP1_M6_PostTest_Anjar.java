...
public class BP1_M6_PostTest_Anjar extends javax.swing.JFrame {
    ...
    String sql = "SELECT nim, nama, jk, kelas, prodi, angkatan, hp, kartumhs, alamat FROM post_test";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BP1_M6_PostTest_Anjar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BP1_M6_PostTest_Anjar().setVisible(true);
            }
        });
    }
