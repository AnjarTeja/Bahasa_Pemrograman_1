...
public class Data_Nilai extends javax.swing.JFrame {
   ...
   private void load_data() {
        Object header[] = {"NIM", "NAMA", "NAMA MK", "NILAI"};
        DefaultTableModel data = new DefaultTableModel(null, header);
        jTable1.setModel(data);
        String sql = "SELECT nim, nama, namamk, nilai FROM tabel_nilai";
        try {
            ...
            while (rs.next()) {
                ...
                String k3 = rs.getString("namamk");
                String k4 = rs.getString("nilai");
    ...
    public void input_data() {
        try {
            ...
            String sql = "INSERT INTO tabel_nilai (nim, nama, namamk, nilai) VALUES ('" 
            + jTextField1.getText() + "', '" 
            + jTextField2.getText() + "', '" 
            + jTextField3.getText() + "', '" 
            + jTextField4.getText() + "')";
    ...
    private void initComponents() {
        ...
        jLabel2.setText("TABEL DATA NILAI");
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            String sql = "UPDATE tabel_nilai SET "
            + "nama='" + jTextField2.getText() + "', "
            + "namamk='" + jTextField3.getText() + "', "
    ...
    try {
        ...
        int confirm = JOptionPane.showConfirmDialog(this, 
                ...
                JOptionPane.YES_NO_OPTION);
        if (confirm == JOptionPane.YES_OPTION) {
            String sql = "DELETE FROM tabel_nilai WHERE nim= '" + nim + "'";
            st = koneksi.con.createStatement();
            st.executeUpdate(sql);
