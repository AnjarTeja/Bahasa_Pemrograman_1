...
public class BP1_M8_P1_Anjar extends javax.swing.JFrame {
    Statement st;
    ResultSet rs;
    koneksi koneksi;

    public BP1_M8_P1_Anjar() {
        koneksi = new koneksi();
        initComponents();
        load_data();
    }
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
       try {
        ...
        String sql_edit = "UPDATE tabel_mhs SET "
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        try {
        st = koneksi.con.createStatement();
        String sql_delete = "DELETE FROM tabel_mhs WHERE nim = '" + jTextField1.getText() + "'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BP1_M8_P1_Anjar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BP1_M8_P1_Anjar().setVisible(true);
            }
        });
    }
