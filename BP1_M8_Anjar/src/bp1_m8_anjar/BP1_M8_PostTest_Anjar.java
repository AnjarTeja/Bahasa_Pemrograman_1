...
public class BP1_M8_PostTest_Anjar extends javax.swing.JFrame {
    Statement st;
    ResultSet rs;
    koneksi koneksi;

    public BP1_M8_PostTest_Anjar() {
        koneksi = new koneksi();
        initComponents();
        load_data();
    }
    ...
    private void initComponents() {
        ...
        jButton2.addInputMethodListener(new java.awt.event.InputMethodListener() {
            public void caretPositionChanged(java.awt.event.InputMethodEvent evt) {
                jButton2CaretPositionChanged(evt);
            }
    ...
    private void jButton2CaretPositionChanged(java.awt.event.InputMethodEvent evt) {//GEN-FIRST:event_jButton2CaretPositionChanged

    }//GEN-LAST:event_jButton2CaretPositionChanged

    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        try {
        if (jTextField1.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Masukkan NIM yang ingin diubah!", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            ...
            String sql = "UPDATE tabel_mhs SET "
                    + "nama='" + jTextField2.getText() + "', "
                    + "jk='" + (jRadioButton1.isSelected() ? jRadioButton1.getText() : jRadioButton2.getText()) + "', "
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        ...
        int confirm = JOptionPane.showConfirmDialog(this, 
                ...
                JOptionPane.YES_NO_OPTION);
        if (confirm == JOptionPane.YES_OPTION) {
            String sql = "DELETE FROM tabel_mhs WHERE nim= '" + nim + "'";
            st = koneksi.con.createStatement();
            st.executeUpdate(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BP1_M8_PostTest_Anjar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BP1_M8_PostTest_Anjar().setVisible(true);
            }
        });
    }
