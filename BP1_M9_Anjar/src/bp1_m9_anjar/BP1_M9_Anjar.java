...
public class BP1_M9_Anjar extends javax.swing.JFrame {
    ...
    private void load_data() {
        ...
        String sql = "SELECT nim, nama, jk, prodi, alamat, kelas, angkatan, hp, kartumhs FROM post_test";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String k8 = rs.getString("hp");
                String k9 = rs.getString("kartumhs");
    ...
    try {
            File file = new File("C:\\Users\\Pongo\\OneDrive\\Documents\\NetBeansProjects\\BP1_M9_Anjar\\src\\bp1_m9_anjar\\reportm9.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BP1_M9_Anjar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BP1_M9_Anjar().setVisible(true);
            }
        });
    }
